...
namespace GastrOs.Sde.Views.WinForms.Generic
{
    ...
    public class LockEditForm : Form
    {
        ...
        public LockEditForm(Control content, bool autoScroll, ButtonsConfig buttonsConfig)
        {
            ...
            closeButton = new Button {Text = "OK"};
            editButton = new Button {Text = "Edit"};
            deleteButton = new Button{Text = "Delete"};
            reportButton = new Button{Text = "Report"};
        ...
        private void InitContent(bool autoScroll)
        {
            ...
            if (content is ScrollableControl)
            {
                if (autoScroll)
                {
                    ...
                    content.Resize += content_Resize; //temp
                }
        ...
        private void UpdateViewEditable()
        {
            ...
            closeButton.Text = editing && (buttonsConfig & ButtonsConfig.EditSave) > 0 ? "Cancel" : "OK";
            editButton.Text = editing ? "Save" : "Edit";
